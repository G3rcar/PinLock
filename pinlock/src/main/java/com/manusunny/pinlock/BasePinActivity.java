...
public abstract class BasePinActivity extends Activity implements PinListener {
    ...
    private void setupStyles() {
        ...
        final int cancelForgotTextSize = styledAttributes.getInt(R.styleable.PinLock_cancelForgotTextSizeSp, 20);
        ...
        final int infoTextSize = styledAttributes.getInt(R.styleable.PinLock_infoTextSizeSp, 20);
